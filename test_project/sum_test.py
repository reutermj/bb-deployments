"""Test that the sum was computed correctly."""
...
class SumTest(unittest.TestCase):
    def test_sum_of_1_to_100(self):
        sum_file = find_runfile("test_project/sum.txt")
        result = int(sum_file.read_text().strip())
        expected = 5050  # sum of 1..100
