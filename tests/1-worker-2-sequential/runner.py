...
# Port allocation: 9040-9045
#   - 9040: frontend (client-facing)
#   - 9041: storage
#   - 9042: scheduler (client gRPC)
#   - 9043: scheduler (worker gRPC)
#   - 9044: scheduler (admin HTTP)
#   - 9045: socket server for test coordination
TEST_PORT = 9045
EXECUTOR_PORT = 9040
