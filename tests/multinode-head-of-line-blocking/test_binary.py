"""Test binary for multinode head-of-line blocking test.
...
The TEST_ID environment variable identifies which test this belongs to.
- "single": the single-node job that runs first
- "multi": the multinode job that should be blocked
"""
